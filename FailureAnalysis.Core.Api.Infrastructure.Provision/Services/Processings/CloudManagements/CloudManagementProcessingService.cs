...
using FailureAnalysis.Core.Api.Infrastructure.Provision.Brokers.Configurations;
...
using FailureAnalysis.Core.Api.Infrastructure.Provision.Services.Foundations.CloudManagements;
